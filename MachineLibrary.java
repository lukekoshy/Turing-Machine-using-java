...
public final class MachineLibrary 
{
	...
	public static TuringMachinee EqualBinaryWords()
	{
		TuringMachinee newTM = new TuringMachinee();
		newTM.addState("qz");
		newTM.addState("q2");
		newTM.addState("q3");
		newTM.addState("q4");
		...
		newTM.addTransition("qz",  '1', "q3", 'x', true);
		newTM.addTransition("qz", '0', "q2", 'x', true);
		newTM.addTransition("qz", '#', "q8", '#', true);
		...
		newTM.addTransition("q7", 'x', "qz", 'x', true);
